...
import { MedicationsClient } from "@/components/medication/MedicationsClient";
...
export default async function ElderMedicationsPage({
  params,
}: {
  ...
  return <MedicationsClient familyId={familyId} elderId={elderId} elderName={elder.name} />;
}
