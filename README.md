...
暂不包含小程序对接、复杂 AI 代理、长期记忆、主动外呼、用药提醒调度、智能硬件和营销页面。吾伴 AI 小程序当前定位为学生端作业练习入口，小安小程序定位为老人端入口，二者先独立运行，后续在平台稳定后再作为数据入口对接。详细边界见 [产品边界](docs/product-boundaries.md)。
